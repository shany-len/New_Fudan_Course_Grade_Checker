...
# $a2 : Límite superior
algoritmo_quicksort:        
               bge        $a1, $a2, algoritmo_quicksort_end        # Si a1<a2 entonces:
               ...
               jal       Particion                        # call Partition(A[], p, r) : same argument as current procedure
               ...
               move      $a2, $v0                        # a2 = v0
               jal       Particion                        # call Quicksort(A[], p, q)

               lw        $a0, 16($sp)                        # load A[]
               lw        $t0, 4($sp)                        # load q
               addi        $a1, $t0, 1                        # a1 = q + 1
               lw        $a2, 8($sp)                        # load r
               jal       algoritmo_uicksort                        # Quicksort(A[], q+1, r)

               addu        $sp, $sp, 20                     # Restaurar el stack
               lw        $ra, 0($sp)                        # Restaurar la dirección de retorno

algoritmo_quicksort_fin:	
		jr        $ra                                # return
